...
<div class="container-fluid px-0">
    <div class="card shadow-sm mb-4 border-0">
        ...
        <form id="edit-form" action="{{ route('category-violence.update', ['category_violence' => $category_violence['id']]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-body">
                <div class="row align-items-center mb-4">
                    <div class="col-md-4 text-center">
                        <img src="{{ $category_violence['image'] }}" alt="Preview" 
                             class="img-fluid rounded shadow-sm border" style="height: 250px; object-fit: cover;" id="img">
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-bold mb-2">Upload Gambar Baru</label>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control @error('category_name') is-invalid @enderror"
                           ...
                           value="{{ old('category_name', $category_violence['category_name']) }}" 
